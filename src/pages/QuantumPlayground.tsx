    ...
    <div className="w-full h-screen bg-[#020617] relative overflow-hidden font-mono cursor-none">
      ...
      {highPerformanceMode ? (
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-0">
          ...
          <h2 className="text-3xl font-bold text-white mb-2">3D Game Requires Effects</h2>
          <p className="text-white/60">Turn off performance mode to play Love Invaders</p>
        </div>
      ) : (
