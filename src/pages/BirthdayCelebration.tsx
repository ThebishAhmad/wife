    ...
    <div className="w-full h-screen bg-gradient-to-br from-pink-200 to-rose-300 relative overflow-hidden">
      ...
      {highPerformanceMode ? (
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
          <img src={birthdayPhoto} alt="Birthday" className="w-64 h-64 object-cover rounded-2xl shadow-lg mb-6" />
          <h2 className="text-4xl font-bold text-pink-800 mb-2">🎂 Happy Birthday! 🎂</h2>
          <p className="text-pink-700">Enable effects for the full 3D celebration experience</p>
        </div>
      ) : (
        <ErrorBoundary>
