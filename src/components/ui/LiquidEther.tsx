  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      init(container: HTMLElement) {
        ...
        this.listenerTarget.addEventListener('mousemove', this.onDocumentMouseMove);
        this.listenerTarget.addEventListener('touchstart', this.onDocumentTouchStart, { passive: true });
        this.listenerTarget.addEventListener('touchmove', this.onDocumentTouchMove, { passive: true });
      ...
      dispose() {
        if (this.listenerTarget) {
          this.listenerTarget.removeEventListener('mousemove', this.onDocumentMouseMove);
          this.listenerTarget.removeEventListener('touchstart', this.onDocumentTouchStart);
          this.listenerTarget.removeEventListener('touchmove', this.onDocumentTouchMove);
